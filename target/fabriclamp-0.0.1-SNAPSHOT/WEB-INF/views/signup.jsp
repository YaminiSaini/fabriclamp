...
<br><br><br><br>
 ...
 <form:form method="post" action="${pageContext.request.contextPath}/AddUserToDB" modelAttribute="User">
    ...
    <div class="container">
        ...
        <h2 class="alert alert-danger">${UserExist}</h2>
        </c:if>
        ...
        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <form:input path="ConfirmPassword" type="password" id="confirmpassword" name="confirmpassword" class="form-control" />
                    <form:errors path="ConfirmPassword" class="text text-danger"/>
                </div>
