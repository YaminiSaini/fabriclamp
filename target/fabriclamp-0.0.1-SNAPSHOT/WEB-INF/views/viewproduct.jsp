...
<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				<label style="font-size: 40px;" class="alert alert-info">View Products</label>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<br>
					<input name="userqty" type="number" placeholder="Enter Qty" min="1" max="10" value="1" class="form-control" />
				</div>
